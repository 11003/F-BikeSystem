...
return {
	...
	getScript: function (scriptLocation, callback) {
		...
		if (head) {
			// Append a new 'script' element, set its type and src attributes, cate a 'load' handler that calls the callback
	...
	animate: function (el, params, options) {
		...
		if (hasEffect) {
			for (key in params) {
				// The fx variable is seemingly thrown away here, but the Effect.setup will cate itself to the _highcharts_animation object
