...
var radialAxisMixin = {
	...
	/**
	 * In case of auto connect, cate one closestPointRange to the max value right before
...
seriesTypes.bubble = extendClass(seriesTypes.scatter, {
	 ...
	 * must be done prior to Series.translate because the axis needs to cate padding in
